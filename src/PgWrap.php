...
class PgWrap
{
     ...
     */
    public static function callSelect(
        string $name,
        array $params,
        ?string $connection = null
    ): array|string|false|int {
        return static::callProc($name, $params, '* FROM ', $connection);
    }
     ...
     */
    public static function callProc(
        string $name,
        array $params,
        string $from = '',
        ?string $connection = null
     ...
     * @return array<iterable>|string|false|int
     */
    public static function callSelectInsecure(
        string $name,
        mixed $params,
        ?string $connection = null
    ): array|string|false|int {
        return static::callProcInsecure(
            $name,
            $params,
            '* FROM ',
            $connection
     ...
     * @return array<iterable>|string|false|int
     */
    public static function callProcInsecure(
        string $name,
        mixed $params,
        string $from = '* FROM ',
        ?string $connection = null
     ...
     */
    public static function callSelectOne(
        string $name,
        array $params,
        ?string $connection = null
    ): stdClass|string|false {
        $ret = static::callProc($name, $params, '* FROM ', $connection);
        /**
     ...
     * @return \stdClass|string|false
     */
    public static function callSelectOneInsecure(
        string $name,
        mixed $params,
        ?string $connection = null
    ): stdClass|string|false {
        $ret = static::callProcInsecure($name, $params, '* FROM ', $connection);
        /**
         * @var array<int, array> $ret
         */
        if (!$ret) {
